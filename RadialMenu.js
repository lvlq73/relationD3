...
function RadialMenu(params) {
	...
	MIN_SECTORS = params.minSectors || 6;
    self.radius      = 50;
...
RadialMenu.prototype.close = function () {
    ...
    if (self.currentMenu) {
        ...
        RadialMenu.setClassAndWaitForTransition(self.currentMenu, 'menu inner').then(function () {
            ...
            self.currentMenu.parentElement.remove();
			self.currentMenu = null;
        });
    }
};
...
RadialMenu.prototype.createHolder = function () {
    ...
    self.holder = document.createElementNS('http://www.w3.org/2000/svg', 'g');
    self.holder.setAttribute('class', 'menuHolder');
	self.holder.setAttribute('id', 'menuHolder');
    ...
    self.nodeDom.parentElement.appendChild(self.holder);
    //console.log(self.nodeDom.appendChild(self.holder));
};
